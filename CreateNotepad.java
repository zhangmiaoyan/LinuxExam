...
public class CreateNotepad extends HttpServlet {
    ...
    final static String URL = "jdbc:mysql://180.76.112.251/LinuxExam";
    final static String USER = "root";
    final static String PASS = "Zxcvbnm,./123";
    final static String SQL_INSERT_NOTEPAD = "INSERT INTO note(id,notepadName,notepadTime) VALUES (?,?, ?)";
